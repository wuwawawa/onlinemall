...
<div class="panel admin-panel">
    ...
    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
        <tr>
            ...
            <td>${data.address}</td>
            <td>
                <a class="button border-main" href="${ctx}/user/findPersonInf?id=${data.id}&type=1"><span class="icon-edit">查看详细信息</span> </a>
                <a class="button border-red" href="${ctx}/user/deleteuser?id=${data.id}"><span class="icon-trash-o">删除用户</span> </a>
            </td>
        </tr>
    </c:forEach>
        <tr>
