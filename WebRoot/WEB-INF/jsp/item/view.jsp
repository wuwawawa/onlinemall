...
<div class="width1198 center_yh" style="height: 420px;">
    <div class="left_yh" style="width: 350px;height: 420px;">
        ...
        <div id="preview">
            ...
            <div id=spec-list" style="margin-top: 5px;">
                <ul class="list-h">
                    <li><img src="${obj.url2}" height="80" width="80" onerror="this.style.display='none'"></li>
                    <li><img src="${obj.url3}" height="80" width="80" onerror="this.style.display='none'"></li>
                    <li><img src="${obj.url4}" height="80" width="80" onerror="this.style.display='none'"></li>
                    <li><img src="${obj.url5}" height="80" width="80" onerror="this.style.display='none'" ></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <p class="font16 c_66" style="margin-top:25px;">
            <font style="margin-right: 20px;">店家：</font>
            <font class="red font20">
                ${sellName}
            </font>
        </p>
