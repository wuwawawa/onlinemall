...
<div class="panel admin-panel">
    <form action="${ctx}/seller/findAllOrders" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px;">
                <li>
                    <input type="text" placeholder="订单号" name="id" class="input" value="${obj.id}"
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                ...
                <td>
                    <a class="button border-main" href="${ctx}/seller/itemList?orderId=${data.orderId}"><span class="icon-edit">查看购买商品</span> </a>
                    <c:if test="${data.status == 0}">
                        <a class="button border-red" href="${ctx}/seller/fh?id=${data.id}"><span class="icon-trash-o">去发货</span> </a>
                    </c:if>
                </td>
            </tr>
        </c:forEach>
